...
import { CoursesViewComponent } from '.';
...
const stories = storiesOf('CoursesViewComponent', module);

stories.addDecorator(reduxDecorator);
stories.addDecorator(AppDecorator);

stories.add('My Courses', () => (
